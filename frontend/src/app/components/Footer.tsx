      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-3 gap-y-8 py-10 max-sm:mx-auto max-sm:max-w-sm sm:grid-cols-4 md:gap-8 lg:grid-cols-6">
          ...
          <div className="text-left lg:mx-auto ">
            <h4 className="mb-7 text-lg font-medium text-gray-400">Products</h4>
          ...
          <div className="text-left lg:mx-auto">
            <h4 className="mb-7 text-lg font-medium text-gray-400">Resources</h4>
            <ul className="text-sm  transition-all duration-500">
              <li className="mb-6">
                <a href="javascript:;" className="text-gray-200 hover:text-gray-400">
                  FAQs
        ...
        <div className="border-t border-gray-200 py-7">
          <div className="flex flex-col items-center justify-center lg:flex-row lg:justify-between">
            <span className="text-sm text-gray-500 ">
              <a href="https://pagedone.io/">GameAnvil</a> 2024, All rights reserved.
            </span>
